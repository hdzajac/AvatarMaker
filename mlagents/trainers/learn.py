...
class SingleRun():
    def run_training(self, sub_id: int, run_seed: int, run_options, process_queue):
        ...
        env = self.init_environment(env_path, docker_target_name, no_graphics, worker_id + sub_id, fast_simulation, run_seed)
    ...
    def init_environment(self, env_path, docker_target_name, no_graphics, worker_id, fast_simulation, seed):
        ...
        if docker_training and env_path is not None:
                ...
                env_path = self.prepare_for_docker_run(docker_target_name,
                                                  env_path)
